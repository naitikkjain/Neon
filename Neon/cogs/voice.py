...
class Voice(commands.Cog):
    ...
    async def mute(self, ctx, member: discord.Member, *, reason: str=None):
        ...
        await ctx.send(f"Successfully voice muted {member.mention}", allowed_mentions=discord.AllowedMentions.none())
    ...
    async def unmute(self, ctx, member: discord.Member, *, reason: str=None):
        ...
        await ctx.send(f"Successfully voice unmuted {member.mention}", allowed_mentions=discord.AllowedMentions.none())
    ...
    async def deafen(self, ctx, member: discord.Member, *, reason: str=None):
        ...
        await ctx.send(f"Successfully voice deafened {member.mention}", allowed_mentions=discord.AllowedMentions.none())
    ...
    async def undeafen(self, ctx, member: discord.Member, *, reason: str=None):
        ...
        await ctx.send(f"Successfully voice undeafened {member.mention}", allowed_mentions=discord.AllowedMentions.none())
    ...
    async def muteall(self, ctx, *, reason: str=None):
        ...
        for user in voice_channel.members:
            if not user.voice.mute:
                unmuted_len += 1
        await ctx.send(f"Voice muting {unmuted_len} users...")
        muted_len = 0
        for user in voice_channel.members:
            if not user.voice.mute:
                muted_len += 1
        ...
        await ctx.send(f"Successfully voice muted {muted_len} users")
    ...
    async def unmuteall(self, ctx, *, reason: str=None):
        ...
        for user in voice_channel.members:
            if user.voice.mute:
                muted_len += 1
        await ctx.send(f"Voice unmuting {muted_len} users...")
        _len = 0
        for user in voice_channel.members:
            if user.voice.mute:
                _len += 1
        ...
        await ctx.send(f"Successfully voice unmuted {_len} users")
    ...
    async def deafenall(self, ctx, *, reason: str=None):
        ...
        for user in voice_channel.members:
            if not user.voice.deaf:
                undeafened_len += 1
        await ctx.send(f"Voice deafening {undeafened_len} users...")
        deafened_len = 0
        for user in voice_channel.members:
            if not user.voice.deaf:
                deafened_len += 1
        ...
        await ctx.send(f"Successfully voice deafened {deafened_len} users")
    ...
    async def undeafenall(self, ctx, *, reason: str=None):
        ...
        for user in voice_channel.members:
            if user.voice.deaf:
                undeafened_len += 1
        await ctx.send(f"Voice undeafening {undeafened_len} users...")
        deafened_len = 0
        for user in voice_channel.members:
            if user.voice.deaf:
                deafened_len += 1
        ...
        await ctx.send(f"Successfully voice undeafened {deafened_len} users")
